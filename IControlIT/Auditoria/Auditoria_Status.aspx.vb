...
Public Class Auditoria_Status
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Call Master.Titulo(
                ...
                "Cadastro de Status de Auditoria ",
            ...
            Call Master.Localizar("sp_Drop_Auditoria_Status", Page.AppRelativeVirtualPath.ToString)

            If Not Request("ID") = Nothing Then
                vdataset = WS_Cadastro.Auditoria_Status(Session("Conn_Banco"), Request("ID"), Nothing, Nothing, "sp_SL_ID", True)
                txtIdentificacao.Text = vdataset.Tables(0).Rows(0).Item("Id_Auditoria_Status")
                txtDescricao.Text = vdataset.Tables(0).Rows(0).Item("Nm_Auditoria_Status")
            End If
        End If
    End Sub
    ...
    Protected Sub btSalvar_Click(sender As Object, e As EventArgs)
        ...
        WS_Cadastro.Credentials = System.Net.CredentialCache.DefaultCredentials
        WS_Cadastro.Auditoria_Status(Session("Conn_Banco"),
