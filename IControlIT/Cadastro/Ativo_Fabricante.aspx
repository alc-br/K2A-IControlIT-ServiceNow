<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeBehind="Ativo_Fabricante.aspx.vb" Inherits="IControlIT.Ativo_Fabricante" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlValidador" runat="server" Style="z-index: 107; left: 297px; position: absolute; top: 298px; height: 46px; width: 100px;">
