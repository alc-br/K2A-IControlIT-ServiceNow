...
Public Class Ativo_Fr_Aquisicao
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Call Master.Titulo(
                ...
                "Cadastro de Forma de Aquisição",
            ...
            Call Master.Localizar("sp_Drop_Ativo_Fr_Aquisicao", Page.AppRelativeVirtualPath.ToString)

            If Not Request("ID") = Nothing Then
                vdataset = WS_Cadastro.Ativo_Fr_Aquisicao(Session("Conn_Banco"), Request("ID"), Nothing, Nothing, "sp_SL_ID", True)
                txtIdentificacao.Text = vdataset.Tables(0).Rows(0).Item("Id_Ativo_Fr_Aquisicao")
                txtDescricao.Text = vdataset.Tables(0).Rows(0).Item("Nm_Ativo_Fr_Aquisicao")
            End If
        End If
    End Sub
    ...
    Protected Sub btSalvar_Click(sender As Object, e As EventArgs)
        ...
        WS_Cadastro.Credentials = System.Net.CredentialCache.DefaultCredentials
        WS_Cadastro.Ativo_Fr_Aquisicao(Session("Conn_Banco"),
