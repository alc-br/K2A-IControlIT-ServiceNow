...
Partial Public Class Ativo_Modelo
    ...
    '''<summary>
    '''Controle lblAtivoFabricante.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents lblAtivoFabricante As Global.System.Web.UI.WebControls.Label

    '''<summary>
    '''Controle cboAtivoFabricante.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents cboAtivoFabricante As Global.System.Web.UI.WebControls.DropDownList

    '''<summary>
    '''Controle rfvAtivoFabricante.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents rfvAtivoFabricante As Global.System.Web.UI.WebControls.RequiredFieldValidator
    ...
    '''<summary>
    '''Controle vceAtivoFabricante.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents vceAtivoFabricante As Global.AjaxControlToolkit.ValidatorCalloutExtender
