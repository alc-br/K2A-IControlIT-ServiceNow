...
Public Class Ativo_Tipo_Sub_Grupo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Call Master.Titulo(
                ...
                "Cadastro Sub Grupo de Tipo de Ativo",
            ...
            Call Master.Localizar("sp_Drop_Sub_Grupo_Ativo_Tipo", Page.AppRelativeVirtualPath.ToString)

            If Not Request("ID") = Nothing Then
                vdataset = WS_Cadastro.Ativo_Tipo_Sub_Grupo(Session("Conn_Banco"), Request("ID"), Nothing, Nothing, "sp_SL_ID", True)
                txtIdentificacao.Text = vdataset.Tables(0).Rows(0).Item("Id_Ativo_Tipo_Sub_Grupo")
                txtDescricao.Text = vdataset.Tables(0).Rows(0).Item("Nm_Ativo_Tipo_Sub_Grupo")
            End If
        End If
    End Sub
    ...
    Protected Sub btSalvar_Click(sender As Object, e As EventArgs)
        ...
        WS_Cadastro.Credentials = System.Net.CredentialCache.DefaultCredentials
        WS_Cadastro.Ativo_Tipo_Sub_Grupo(Session("Conn_Banco"),
