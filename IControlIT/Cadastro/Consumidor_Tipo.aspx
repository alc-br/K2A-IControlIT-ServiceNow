<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeBehind="Consumidor_Tipo.aspx.vb" Inherits="IControlIT.Consumidor_Tipo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlValidador" runat="server" Style="z-index: 107; left: 208px; position: absolute; top: 316px; height: 38px; width: 172px;">
