...
Public Class Empresa_Contratada
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Call Master.Localizar("sp_Drop_Empresa_Contratada", Page.AppRelativeVirtualPath.ToString)

            If Not Request("ID") = Nothing Then
                vdataset = WS_Cadastro.Empresa_Contratada(Session("Conn_Banco"), Request("ID"), Nothing, Nothing, Nothing, Nothing, Nothing, "sp_SL_ID", True)
                txtIdentificacao.Text = vdataset.Tables(0).Rows(0).Item("Id_Empresa_Contratada")
                txtDescricao.Text = vdataset.Tables(0).Rows(0).Item("Nm_Empresa_Contratada")
                txtCNPJ.Text = vdataset.Tables(0).Rows(0).Item("CNPJ")
                txtContato.Text = vdataset.Tables(0).Rows(0).Item("Contato")
                txtTelefone.Text = vdataset.Tables(0).Rows(0).Item("Telefone")
            End If
        End If
    End Sub
    ...
    Protected Sub btSalvar_Click(sender As Object, e As EventArgs)
        ...
        WS_Cadastro.Credentials = System.Net.CredentialCache.DefaultCredentials
        WS_Cadastro.Empresa_Contratada(Session("Conn_Banco"),
                                            ...
                                            oConfig.ValidaCampo(txtTelefone.Text),
                                            Session("Id_Usuario"),
                                            "sp_SM",
                                            False)
        '-----registro salvo ok
