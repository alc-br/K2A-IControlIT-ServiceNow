...
Public Class Holding
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Call Master.Localizar("sp_Drop_Holding", Page.AppRelativeVirtualPath.ToString)

            If Not Request("ID") = Nothing Then
                vdataset = WS_Cadastro.Holding(Session("Conn_Banco"), Request("ID"), Nothing, Nothing, Nothing, "sp_SL_ID", True)
                txtIdentificacao.Text = vdataset.Tables(0).Rows(0).Item("Id_Holding")
                txtDescricao.Text = vdataset.Tables(0).Rows(0).Item("Nm_Holding")
                txtLogo.Text = vdataset.Tables(0).Rows(0).Item("Logo")
            End If
        End If
    End Sub
