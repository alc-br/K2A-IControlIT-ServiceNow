<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeBehind="Tronco.aspx.vb" Inherits="IControlIT.Tronco" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <asp:DropDownList ID="cboConglomerado" runat="server" CssClass="configCombo" EnableTheming="True" Width="100%" TabIndex="2"></asp:DropDownList>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <asp:Label ID="lblTroncoGrupo" runat="server" CssClass="configlabel" Text="Grupo de rota"></asp:Label>
                            <asp:DropDownList ID="cboAtivoStatus" runat="server" CssClass="configCombo" EnableTheming="True" Width="100%" TabIndex="3"></asp:DropDownList>
                        </div>
                        <div class="col-md-6">
    ...
    <asp:Panel ID="pnlValidador" runat="server" Style="z-index: 107; left: 154px; position: absolute; top: 397px; height: 86px;">
