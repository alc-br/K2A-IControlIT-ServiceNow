<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeBehind="Usuario_Grupo.aspx.vb" Inherits="IControlIT.Usuario_Grupo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlValidador" runat="server" Style="z-index: 107; left: 263px; position: absolute; top: 313px; height: 38px; width: 125px;">
