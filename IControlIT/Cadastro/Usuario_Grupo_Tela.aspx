<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeBehind="Usuario_Grupo_Tela.aspx.vb" Inherits="IControlIT.Usuario_Grupo_Tela" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <asp:Label ID="lblGrupoUsuario" runat="server" CssClass="configlabel" Text="Grupo de usuário" ForeColor="#8A6D3B"></asp:Label>
                            <asp:DropDownList ID="cboUsuarioGrupo" runat="server" CssClass="configCombo" EnableTheming="True" Width="100%" AutoPostBack="True" TabIndex="1"></asp:DropDownList>
                            <asp:RequiredFieldValidator ID="rfvUsuarioGrupo" runat="server" ControlToValidate="cboUsuarioGrupo" Display="None" SetFocusOnError="True" Style="left: 534px; top: 37px; float: left;"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <!--Relacionamento-->
                    <div class="row">
    ...
    <asp:Panel ID="pnlValidador" runat="server" Style="z-index: 107; left: 196px; position: absolute; top: 441px; height: 43px; width: 163px;">
