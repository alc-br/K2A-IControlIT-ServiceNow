...
Public Class Solicitacao
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            ''-----valida botão menu
            ''Call Master.SelecionaBotao("usuario")
            ...
            oConfig.CarregaCombo(cboAtivoTipo, WS_Cadastro.DropList_Filtro(Session("Conn_Banco"), "sp_Drop_Ativo_Tipo_Usuario", Session("Id_Usuario"), Nothing))
            ...
            If Not Request("ID") = Nothing Then
                ...
                oConfig.CarregaCombo(cboSolicitacao, WS_Cadastro.DropList_Filtro(Session("Conn_Banco"), "sp_Drop_Solicitacao_Tipo_Id_Ativo_Tipo_Usuario", cboAtivoTipo.SelectedValue, Nothing))
                ...
                If Session("Id_Usuario_Perfil_Acesso") = 1 Then
                    ...
                    'lblDescInformacao.Enabled = True
                    btInformacoes.Style.Add("Opacity", "1")
                    'lblDescInformacao.Style.Add("Opacity", "1")
                End If
                ...
                If txtStatus.Text = "Aberto" Then
                    ...
                    'lblDescEncerrar.Style.Add("Opacity", "1")
            ...
            If txtStatus.Text = "Encerrado" Then
                If txtUsuario.Text = Session("Nm_Usuario") Then
                    ...
                    'lblDescAvaliacao.Enabled = True
                    btAvaliacao.Style.Add("Opacity", "1")
                    'lblDescAvaliacao.Style.Add("Opacity", "1")
                End If
                ...
                'lblDescSalvar.Style.Add("Opacity", "0.3")

                btEncerrar.Enabled = False
                btEncerrar.Style.Add("Opacity", "0.5")
                'lblDescEncerrar.Style.Add("Opacity", "0.3")
    ...
    Protected Sub cboSolicitacao_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboSolicitacao.SelectedIndexChanged
        ...
        vdataset = WS_Modulo.Solicitacao(Session("Conn_Banco"), _
                                        Nothing, Nothing, Nothing, Nothing, Nothing, cboSolicitacao.SelectedValue, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, Nothing, _
                                        "sp_Config_Caixa_Texto", _
                                        True)

        lblDetalhamento.Text = vdataset.Tables(0).Rows(0).Item("Fl_Config_Caixa_Texto")
    End Sub

    Protected Sub btInsere_Click(sender As Object, e As System.EventArgs)
    ...
    Protected Sub btOk_Click(sender As Object, e As System.EventArgs) Handles btOk.Click
        ...
        T = WS_Modulo.Solicitacao(Session("Conn_Banco"), _
                                    ...
                                    "sd_Email_Encerramento_Chamado", _
                                    False).Tables(0).Rows(0).Item(0)
        pnlDetalhe.Visible = False
    ...
    Protected Sub btAvaliacao_Click(sender As Object, e As EventArgs)
        ...
        Else
            btSalvarAvaliacao.Enabled = True
            btSalvar.Style.Add("Opacity", "1")
            'lblDescSalvar.Style.Add("Opacity", "1")
        End If
    End Sub
