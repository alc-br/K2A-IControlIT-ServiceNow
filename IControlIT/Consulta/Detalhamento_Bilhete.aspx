<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeBehind="Detalhamento_Bilhete.aspx.vb" Inherits="IControlIT.Detalhamento_Bilhete" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="pnlAbir" runat="server" class="bgModal" visible="True">
        <div class="modalPopup">
            <div class="row">
                <div class="col-md-12">
                    <asp:Label ID="lblDLinhaConta" runat="server" CssClass="configlabel" Text="Abrir Detalhamento" Style="float: left" Font-Names="Segoe UI Semibold" Font-Size="18pt"></asp:Label>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <asp:DropDownList ID="cboDataDe" runat="server" Style="float: left" Width="195px" TabIndex="2" CssClass="configCombo"></asp:DropDownList>
                </div>
                <div class="col-md-6">
                    ...
                    <asp:DropDownList ID="cboDataAte" runat="server" Width="195px" TabIndex="3" CssClass="configCombo"></asp:DropDownList>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <asp:RequiredFieldValidator ID="rfvDe" runat="server" ControlToValidate="cboDataDe" Font-Names="Arial" Font-Size="10pt" Style="left: 445px; top: 38px; float: left;">*</asp:RequiredFieldValidator>
                    <asp:RequiredFieldValidator ID="rfvAte" runat="server" ControlToValidate="cboDataAte" Font-Names="Arial" Font-Size="10pt" Style="left: 445px; top: 38px; float: left;">*</asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div id="divGrid" runat="server" style="left: 5px; overflow: auto; width: 100%; top: 103px; height: 470px;" title=" ">
