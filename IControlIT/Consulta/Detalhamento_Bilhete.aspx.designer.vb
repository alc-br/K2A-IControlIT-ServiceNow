...
Partial Public Class Detalhamento_Bilhete
    ...
    '''</remarks>
    Protected WithEvents pnlAbir As Global.System.Web.UI.HtmlControls.HtmlGenericControl
    ...
    '''<summary>
    '''Controle cboGrupoAtivo.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents cboGrupoAtivo As Global.System.Web.UI.WebControls.ListBox
    ...
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents cboConglomerado As Global.System.Web.UI.WebControls.ListBox
    ...
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents cboDataDe As Global.System.Web.UI.WebControls.DropDownList
    ...
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents cboDataAte As Global.System.Web.UI.WebControls.DropDownList
    ...
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents rfvDe As Global.System.Web.UI.WebControls.RequiredFieldValidator
    ...
    '''<summary>
    '''Controle lblDescricaoArquivo.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents lblDescricaoArquivo As Global.System.Web.UI.WebControls.Label
