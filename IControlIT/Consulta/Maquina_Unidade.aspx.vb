...
Public Class Consulta_Maquina_Unidade
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            oConfig.CarregaList(cboConglomerado, WS_Cadastro.DropList_Filtro(Session("Conn_Banco"), "sp_Drop_Conglomerado_Solicitacao", Session("Id_Usuario"), Nothing))
    ...
    Protected Sub btExecutar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btExecutar.Click
        ...
        'TODO: Procurar onde está essa function que deveria estar no WS mas não existe
        Session("DataSet") = Nothing ' WS_Consulta.Fornecedor_Unidade(Session("Conn_Banco"), oConfig.ValidaCampo(cboConglomerado.SelectedValue), "sp_Fornecedor_Unidade")
        ...
        lblDescricaoArquivo.Text = "Arquivo | Conglomerado: " & cboConglomerado.SelectedValue
    End Sub
    ...
    Protected Sub btExportar_Click(sender As Object, e As EventArgs)
        ...
        Dim Descricao As System.String = "Relatorio_Unidade_Maquinas"
