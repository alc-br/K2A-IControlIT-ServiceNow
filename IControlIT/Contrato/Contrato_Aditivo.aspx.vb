...
Public Class Contrato_Aditivo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Call Master.Localizar("sp_Drop_Contrato_Aditivo", Page.AppRelativeVirtualPath.ToString)
            ...
            If Not Request("ID") = Nothing Then
                vdataset = WS_Contrato.Contrato_Aditivo(Session("Conn_Banco"), Request("ID"), Nothing, Nothing, _
                                                                Nothing, Nothing, "sp_SL_ID", True)
                txtIdentificacao.Text = vdataset.Tables(0).Rows(0).Item("Id_Contrato_Aditivo")
                ...
                txtDataVigencia.Text = vdataset.Tables(0).Rows(0).Item("Dt_Vigencia")
            End If
        End If
    End Sub
    ...
    Protected Sub btSalvar_Click(sender As Object, e As EventArgs)
        WS_Contrato.Contrato_Aditivo(Session("Conn_Banco"), oConfig.ValidaCampo(txtIdentificacao.Text),
                                    oConfig.ValidaCampo(cboContrato.SelectedValue),
                                    oConfig.ValidaCampo(txtDataVigencia.Text),
    ...
    Protected Sub btDesativar_Click(sender As Object, e As EventArgs)
        ...
        WS_Contrato.Contrato_Aditivo(Session("Conn_Banco"),
