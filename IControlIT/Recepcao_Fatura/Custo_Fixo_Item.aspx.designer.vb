...
Partial Public Class Custo_Fixo_Item
    ...
    '''<summary>
    '''Controle cboDescricao.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents cboDescricao As Global.System.Web.UI.WebControls.DropDownList
    ...
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents rfvValor As Global.System.Web.UI.WebControls.RequiredFieldValidator
    ...
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents mevValor As Global.AjaxControlToolkit.MaskedEditValidator
    ...
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents vceValor As Global.AjaxControlToolkit.ValidatorCalloutExtender
    ...
    '''Para modificar, mova a declaração de campo do arquivo de designer a um arquivo code-behind.
    '''</remarks>
    Protected WithEvents meeValor As Global.AjaxControlToolkit.MaskedEditExtender
