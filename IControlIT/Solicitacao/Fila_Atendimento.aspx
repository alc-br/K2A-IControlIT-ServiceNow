<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeBehind="Fila_Atendimento.aspx.vb" Inherits="IControlIT.Fila_Atendimento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-warning">
                                <div class="panel-heading row">
                                    <div class="col-md-12">
                                        <asp:Label ID="lblMontaHierarquia" runat="server" CssClass="configlabel" Text="Usuário da Fila" Font-Bold="False"></asp:Label>
                                    </div>
                                    <div class="col-md-12">
                                            ...
                                            <table style="width: 100%">
                                                <tr>
                                                    ...
                                                    <td style="width: 30px; background-color: #09A8C5; border-radius: 0px 4px 4px 0px">
                                                        <asp:LinkButton ID="btGrupo" runat="server" CssClass="nav-link" CausesValidation="false" OnClick="btGrupo_Click">
                                            ...
                                            <table style="width: 100%;">
                                                <tr>
                                                    ...
                                                    <td style="width: 45px; background-color: #09A8C5; text-align: center; border-radius: 0px 4px 4px 0px">
                                                        <asp:LinkButton ID="btMoveSelecionado" runat="server" CausesValidation="false" CssClass="nav-link" Style="position: relative; width: 100%; height: 90px;" OnClick="btGrupo_Click">
                                        ...
                                        <div style="width: 100%; border: 1px solid #818181; border-radius: 4px">
                                            <table style="width: 100%;">
                                                <tr>
                                                    ...
                                                    <td style="width: 45px; background-color: #09A8C5; text-align: center; border-radius: 0px 4px 4px 0px">
                                                        <asp:LinkButton ID="btMoveSelecao" runat="server" CausesValidation="false" CssClass="nav-link" Style="position: relative; width: 100%; height: 90px;" OnClick="btGrupo_Click">
    ...
    <asp:Panel ID="pnlValidador" runat="server" Style="z-index: 107; left: 206px; position: absolute; top: 488px; height: 53px; width: 129px;">
