...
Public Class Fila_Atendimento
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Call Master.Titulo( _
                ...
                "Cadastro de Fila de Atendimento  ", _
            ...
            Call Master.Localizar("sp_Drop_Solicitacao_Fila_Atendimento", Page.AppRelativeVirtualPath.ToString)

            If Not Request("ID") = Nothing Then
                vdataset = WS_Cadastro.Solicitacao_Fila_Atendimento(Session("Conn_Banco"), Request("ID"), Nothing, Nothing, "sp_SL_ID", True)

                txtIdentificacao.Text = vdataset.Tables(0).Rows(0).Item("Id_Solicitacao_Fila_Atendimento")
                txtDescricao.Text = vdataset.Tables(0).Rows(0).Item("Nm_Solicitacao_Fila_Atendimento")

                '-----monta cadastro de hierarquia
                vdataset = WS_Cadastro.Solicitacao_Fila_Atendimento(Session("Conn_Banco"), Request("ID"), Nothing, Nothing, "sd_SL_Rl_Usuario_Fila_Atendimento", True)
    ...
    Protected Sub btGrupo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btGrupo.Click
        '-----carrega consumidor
        WS_Cadastro.Credentials = System.Net.CredentialCache.DefaultCredentials
        oConfig.CarregaList(lstOrigem, WS_Cadastro.DropList(Session("Conn_Banco"), "sp_Drop_Usuario", txtGrupo.Text))
    End Sub
    ...
    Protected Sub btSalvar_Click(sender As Object, e As EventArgs)
        WS_Cadastro.Credentials = System.Net.CredentialCache.DefaultCredentials
        txtIdentificacao.Text = WS_Cadastro.Solicitacao_Fila_Atendimento(Session("Conn_Banco"),
        ...
        WS_Cadastro.Credentials = System.Net.CredentialCache.DefaultCredentials
        WS_Cadastro.Relacionamento(Session("Conn_Banco"), "sp_Rl_Hi_Usuario_Fila_Atendimento_Insere", txtIdentificacao.Text, oConfig.AgrupaDados(lstDestino))
    ...
    Protected Sub btDesativar_Click(sender As Object, e As EventArgs)
        ...
        WS_Cadastro.Credentials = System.Net.CredentialCache.DefaultCredentials
        WS_Cadastro.Solicitacao_Fila_Atendimento(Session("Conn_Banco"),
