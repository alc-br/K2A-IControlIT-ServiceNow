<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeBehind="Solicitacao_Unidade.aspx.vb" Inherits="IControlIT.Solicitacao_Unidade" EnableEventValidation="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <!--dados da unidade-->
    <div id="pnlDadosUnidade" runat="server" class="bgModal" visible="false">
        <div class="modalUnidade">
            <div class="row">
                <div class="col-md-12 text-center">
                    <asp:Label ID="lblDadosUnidade" runat="server" CssClass="lblTituloChat" Text="Dados da Unidade" Style="float: none;" Font-Names="Segoe UI Light" Font-Size="22pt"></asp:Label>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <asp:Label ID="lblNm_Unidade" runat="server" CssClass="configlabel" Text="Unidade" Style="float: none"></asp:Label>
                        <asp:TextBox ID="txtNmUnidade" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="100%" CssClass="configtext" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <asp:Label ID="lblIE" runat="server" CssClass="configlabel" Text="IE" Style="float: none" ForeColor="#33CC33"></asp:Label>
                        <asp:TextBox ID="txtIE" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="100%" CssClass="configtext"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <asp:Label ID="lblObservacaoUnidade" runat="server" CssClass="configlabel" Text="Observação" Style="float: none" ForeColor="#33CC33"></asp:Label>
                        <asp:TextBox ID="txtObservacaoUnidade" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="100%" CssClass="configtext" Height="70px" TextMode="MultiLine"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <asp:Label ID="lblEntregaEndereco" runat="server" CssClass="configlabel" Text="End.Entrega" ForeColor="#33CC33" Style="float: none"></asp:Label>
                        <asp:TextBox ID="txtEntregaEndereco" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="100%" CssClass="configtext" Height="70px" TextMode="MultiLine"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <asp:Label ID="lblFaturamentoContato" runat="server" CssClass="configlabel" Text="Cont.Fatura" Style="float: none" ForeColor="#33CC33"></asp:Label>
                        <asp:TextBox ID="txtFaturamentoContato" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="100%" CssClass="configtext"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <asp:Label ID="lblFaturamentoCNPJ" runat="server" CssClass="configlabel" Text="CNPJ.Fatura" Style="float: none" ForeColor="#33CC33"></asp:Label>
                        <asp:TextBox ID="txtFaturamentoCNPJ" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="100%" CssClass="configtext"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <asp:Label ID="lblFaturamentoEmail" runat="server" CssClass="configlabel" Text="Email.Fatura" Style="float: none" ForeColor="#33CC33"></asp:Label>
                        <asp:TextBox ID="txtFaturamentoEmail" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="100%" CssClass="configtext"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <asp:Label ID="lblMatricula" runat="server" CssClass="configlabel" Text="Matrícula" Style="float: none"></asp:Label>
                        <asp:TextBox ID="txtMatricula" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="100%" CssClass="configtext" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <asp:Label ID="lblCNPJ" runat="server" CssClass="configlabel" Text="CNPJ" Style="float: none" ForeColor="#33CC33"></asp:Label>
                        <asp:TextBox ID="txtCNPJ" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="100%" CssClass="configtext"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <asp:Label ID="lblDataAtivacao" runat="server" CssClass="configlabel" Text="Horário de Atendimento" Style="float: none" ForeColor="#33CC33"></asp:Label>
                        <asp:TextBox ID="txtDataAtivacao" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="100%" CssClass="configtext"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <asp:Label ID="lblEntregaContato" runat="server" CssClass="configlabel" Text="Cont.Entrega" ForeColor="#33CC33" Style="float: none"></asp:Label>
                        <asp:TextBox ID="txtEntregaContato" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="100%" CssClass="configtext"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <asp:Label ID="lblEntregaTelefone" runat="server" CssClass="configlabel" Text="Tel.Entrega" ForeColor="#33CC33" Style="float: none"></asp:Label>
                        <asp:TextBox ID="txtEntregaTelefone" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="100%" CssClass="configtext"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <asp:Label ID="lblFaturamentoEndereco" runat="server" CssClass="configlabel" Text="End.Fatura" Style="float: none" ForeColor="#33CC33"></asp:Label>
                        <asp:TextBox ID="txtFaturamentoEndereco" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="100%" CssClass="configtext" Height="70px" TextMode="MultiLine"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <asp:Label ID="lblFaturamentoIE" runat="server" CssClass="configlabel" Text="IE.Fatura" Style="float: none" ForeColor="#33CC33"></asp:Label>
                        <asp:TextBox ID="txtFaturamentoIE" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="100%" CssClass="configtext"></asp:TextBox>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <asp:Label ID="lblFaturamentoTelefone" runat="server" CssClass="configlabel" Text="Tel.Fatura" Style="float: none" ForeColor="#33CC33"></asp:Label>
                        <asp:TextBox ID="txtFaturamentoTelefone" runat="server" BorderStyle="Solid" BorderWidth="1px" Width="100%" CssClass="configtext"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 text-right">
                    <ul style="list-style-type: none; margin: 0; padding: 0">
                        <li style="display: inline-block">
                            <asp:Button ID="btSairDadosUnidade" class="btn btn-default" runat="server" Text="Sair" CausesValidation="False" />
                        </li>
                        <li style="display: inline-block">
                            <asp:Button ID="btPdfDadosUnidade" class="btn btn-primary" Style="float: none" runat="server" Text="PDF" CausesValidation="False" OnClick="btPdfDadosUnidade_Click" />
                        </li>
                        <li style="display: inline-block">
                            <asp:Button ID="btExportarTela" class="btn btn-primary" Style="float: none" runat="server" Text="Exportar" CausesValidation="False" OnClick="btExportarTela_Click" />
                        </li>
                        <li style="display: inline-block">
                            <asp:Button ID="btSalvarDadosUnidade" class="btn btn-success" runat="server" Text="Salvar" CausesValidation="False" />
                        </li>
                    </ul>
                    <asp:HiddenField ID="hdfId_Consumidor_Unidade" runat="server" />
                </div>
            </div>
        </div>
    </div>
    ...
    <!--criacao do ativo-->
    <div id="pnlCriaAtivo" runat="server" class="bgModal" visible="false">
        <div class="modalAvaliacao">
            <div class="row">
                <div class="col-md-12 text-center">
                    <asp:Label ID="lblAtivoSolicitacao" runat="server" CssClass="configlabel" Text="Criação do Ativo" Style="float: none" Font-Names="Segoe UI Semibold" Font-Size="18pt"></asp:Label>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <asp:Label ID="lblNumeroSerie" runat="server" CssClass="configlabel" Text="* Número de Série" Style="float: none"></asp:Label>
                        <asp:TextBox ID="txtNumeroAtivoUnidade" runat="server" CssClass="configtext" MaxLength="50" Width="100%" TabIndex="0" ReadOnly="True"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <asp:Label ID="lblTipoAtivo" runat="server" CssClass="configlabel" Text="* Tipo do ativo" Style="float: none"></asp:Label>
                        <asp:DropDownList ID="cboTipoAtivo" runat="server" CssClass="configCombo" TabIndex="0" Width="100%" Enabled="False"></asp:DropDownList>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <asp:Label ID="lblConglomerado" runat="server" CssClass="configlabel" Text="* Fornecedor" Style="float: none"></asp:Label>
                        <asp:DropDownList ID="cboConglomerado" runat="server" CssClass="configCombo" TabIndex="0" Width="100%" Enabled="False"></asp:DropDownList>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <asp:Label ID="lblUnidadeAtivo" runat="server" CssClass="configlabel" Text="* Unidade" Style="float: none"></asp:Label>
                        <asp:DropDownList ID="cboUnidadeAtivo" runat="server" CssClass="configCombo" TabIndex="0" Width="100%" Enabled="False"></asp:DropDownList>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <asp:Label ID="lblObservacaoAtivo" runat="server" CssClass="configlabel" Text="Observação" Style="float: none"></asp:Label>
                        <asp:TextBox ID="txtObservacaoAtivo" runat="server" CssClass="configtext" MaxLength="300" Width="100%" TabIndex="1" Height="150px" TextMode="MultiLine" ReadOnly="True"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 text-right">
                    <ul style="list-style-type: none; margin: 0; padding: 0">
                        <li style="display: inline">
                            <asp:Button ID="btFecharAtivo" class="btn btn-default" runat="server" Text="Fechar" CausesValidation="False" />
                        </li>
                        <li id="tbPDF" runat="server" visible="false" style="display: inline">
                            <asp:Button ID="btPDF" class="btn btn-success" runat="server" Text="PDF NF" CausesValidation="False" Visible="true" />
                        </li>
                        <li style="display: inline">
                            <asp:Button ID="btSalvarAtivo" class="btn btn-warning" runat="server" Text="Criar" CausesValidation="False" Visible="false" />
                        </li>
                    </ul>
                    <asp:HiddenField ID="hdfIdAtivoUnidade" runat="server" />
                    <asp:HiddenField ID="hdfIdSolicitacaoUnidadeProcesso" runat="server" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="pnlSolicitacaoMatricula" runat="server" class="bgModal" visible="false">
        <div class="modalAvaliacao">
            <div class="row">
                <div class="col-md-12 text-center">
                    <asp:Label ID="Label2" runat="server" CssClass="configlabel" Text="Solicitação de Matrícula" Style="float: none" Font-Names="Segoe UI Semibold" Font-Size="18pt"></asp:Label>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <asp:Label ID="Label3" runat="server" CssClass="configlabel" Text="N° da Matrícula" Style="float: none"></asp:Label>
                    <asp:TextBox ID="txtNrMatricula" runat="server" CssClass="configtext" MaxLength="50" Width="100%" TabIndex="0" ReadOnly="True"></asp:TextBox>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 text-right">
                    <ul style="list-style-type: none; margin: 0; padding: 0">
                        <li style="display: inline-block">
                            <asp:Button ID="btnFecharMatricula" class="btn btn-default" runat="server" Text="Fechar" CausesValidation="False" OnClick="btnFecharMatricula_Click" />
                        </li>
                        <li style="display: inline-block">
                            <asp:Button ID="btnPdfMatricula" class="btn btn-success" runat="server" Text="PDF" CausesValidation="False" Visible="true" />
                        </li>
                        <li style="display: inline-block">
                            <asp:Button ID="btnSalvarMatricula" class="btn btn-warning" runat="server" Text="Salvar" CausesValidation="False" Visible="true" />
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <!--Solicitação de Numero de Série-->
    <div id="pnlSolicitacaoDevolucao" runat="server" class="bgModal" visible="false">
        <div class="modalAvaliacao">
            <div class="row">
                <div class="col-md-12 text-center">
                    <asp:Label ID="Label4" runat="server" CssClass="configlabel" Text="Solicitação de Devolução" Style="float: left" Font-Names="Segoe UI Semibold" Font-Size="18pt"></asp:Label>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <asp:Label ID="Label5" runat="server" CssClass="configlabel" Text="N° de Série" Style="float: none"></asp:Label>
                    <asp:TextBox ID="txtNrSerieDevolucao" runat="server" CssClass="configtext" MaxLength="50" Width="100%" TabIndex="0" ReadOnly="True"></asp:TextBox>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 text-right">
                    <ul style="list-style-type: none; margin: 0; padding: 0">
                        <li style="display: inline-block">
                            <asp:Button ID="btnFecharDevolucao" class="btn btn-default" runat="server" Text="Fechar" CausesValidation="False" OnClick="btnFecharDevolucao_Click" />
                        </li>
                        <li style="display: inline-block">
                            <asp:Button ID="btnSalvarDevolucao" class="btn btn-warning" runat="server" Text="Salvar" CausesValidation="False" Visible="true" />
                        </li>
                    </ul>
                    ...
                    <div class="col-md-12">
                        <div class="card-body" style="box-shadow: none;">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <asp:Label ID="lblUnidade" Style="float: left" runat="server" CssClass="configlabel" Text="* Unidade"></asp:Label>
                                        <asp:DropDownList ID="cboUnidade" runat="server" Width="100%" CssClass="configCombo" EnableTheming="True" AutoPostBack="True"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="rfvUnidade" runat="server" ControlToValidate="cboUnidade" Display="None" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <asp:Label ID="lblTipoGrupo" runat="server" Style="float: left" CssClass="configlabel" Text="* Grupo"></asp:Label>
                                        <asp:DropDownList ID="cboTipoGrupo" runat="server" AutoPostBack="True" CssClass="configCombo" EnableTheming="True" Width="100%"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="rfvTipoGrupo" runat="server" ControlToValidate="cboTipoGrupo" Display="None" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <asp:Label ID="lblTipoSubGrupo" runat="server" Style="float: left" CssClass="configlabel" Text="* Sub Grupo"></asp:Label>
                                        <asp:DropDownList ID="cboTipoSubGrupo" runat="server" AutoPostBack="True" CssClass="configCombo" EnableTheming="True" Width="100%"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="rfvTipoSubGrupo" runat="server" ControlToValidate="cboTipoSubGrupo" Display="None" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="cboSolucaoAtivoTipo" runat="server" AutoPostBack="True" CssClass="configCombo" EnableTheming="True" Width="100%"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="rfvTipoAtivo" runat="server" ControlToValidate="cboSolucaoAtivoTipo" Display="None" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <div id="lnImg" runat="server" class="row" visible="false">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div style="height: 10px"></div>
                                        <div style="width: 100%; background-color: #FFFFFF; border: 1px solid #818181; border-radius: 4px">
                                            <asp:Image ID="imgEquipamento" runat="server" CssClass="center" ImageUrl="~/Img_Sistema/Tipo_Ativo/VRS16.png" Style="padding: 30px; max-width: 450px" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <asp:Label ID="lblSolicitacao" runat="server" Style="float: left" CssClass="configlabel" Text="* Tipo"></asp:Label>
                                        <asp:DropDownList ID="cboSolicitacao" runat="server" AutoPostBack="True" CssClass="configCombo" EnableTheming="True" Width="100%"></asp:DropDownList>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <asp:Label ID="lblDetalhamento" runat="server" Style="float: left" CssClass="configlabel" Text="* Detalhamento"></asp:Label>
                                        <asp:TextBox ID="txtDetalhamento" runat="server" CssClass="configtext" Height="87px" MaxLength="200" TextMode="MultiLine" Width="100%"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvDetalhamento" runat="server" ControlToValidate="txtDetalhamento" Display="None" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <asp:Panel ID="pnlValidador" runat="server">
        ...
        <cc1:ValidatorCalloutExtender ID="vceTipoGrupo" runat="server" TargetControlID="rfvTipoGrupo"></cc1:ValidatorCalloutExtender>
        <cc1:ValidatorCalloutExtender ID="vceTipoSubGrupo" runat="server" TargetControlID="rfvTipoSubGrupo"></cc1:ValidatorCalloutExtender>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div id="tbBotao" runat="server" class="scrollmenu">
        ...
        <asp:LinkButton ID="btEncerrar" runat="server" CssClass="btn-menu-toolbar" Visible="true" Style="opacity: 1;" Enabled="true" OnClick="btEncerrar_Click">
            <i class="fas fa-recycle"></i>
            <br />
            <span id="lblEncerrar" runat="server">Encerrar</span>
        </asp:LinkButton>
        <asp:LinkButton ID="btInformacoes" runat="server" CssClass="btn-menu-toolbar" CausesValidation="false" Visible="true" Style="opacity: 1;" Enabled="true" OnClick="btInformacoes_Click">
        ...
        <asp:LinkButton ID="btFornecedor" runat="server" CssClass="btn-menu-toolbar" CausesValidation="false" Visible="true" Style="opacity: 1;" Enabled="true" OnClick="btFornecedor_Click">
            <i class="fas fa-file-alt"></i>
            <br />
            <span id="lblFornecedor" runat="server">Fornecedor</span>
        </asp:LinkButton>
        <asp:LinkButton ID="btAvaliacao" runat="server" CssClass="btn-menu-toolbar" CausesValidation="false" Visible="true" Style="opacity: 1;" Enabled="true" OnClick="btAvaliacao_Click">
            <i class="fas fa-star"></i>
            <br />
            <span>Avaliação</span>
        </asp:LinkButton>
        <asp:LinkButton ID="btExportar" runat="server" CssClass="btn-menu-toolbar" Visible="true" Style="opacity: 1;" Enabled="true">
            <i class="fas fa-file-upload"></i>
            <br />
            <span>Exportar</span>
        </asp:LinkButton>
        <asp:LinkButton ID="btRelatorio" runat="server" CssClass="btn-menu-toolbar" CausesValidation="false" Visible="false" Style="opacity: 0.1;" Enabled="false">
