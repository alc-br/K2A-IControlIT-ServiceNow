<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeBehind="Consumidor_Status.aspx.vb" Inherits="IControlIT.Consumidor_Status" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlValidador" runat="server" Style="z-index: 107; left: 224px; position: absolute; top: 326px; height: 38px; width: 141px;">
