<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeBehind="Departamento.aspx.vb" Inherits="IControlIT.Departamento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:TextBox ID="txtDescricao" runat="server" CssClass="configtext" MaxLength="50" TabIndex="1" Style="left: 2px; position: relative; top: 0px; width: 100%"></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:TextBox ID="txtIdentificacao" runat="server" CssClass="configtext" ReadOnly="True" Style="left: 2px; position: relative;" Width="100%" ForeColor="#FF9900"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <asp:Panel ID="pnlValidador" runat="server" Style="z-index: 107; left: 166px; position: absolute; top: 534px; height: 38px; width: 133px;">
