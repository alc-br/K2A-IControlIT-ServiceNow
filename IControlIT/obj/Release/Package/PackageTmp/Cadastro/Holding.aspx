<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeBehind="Holding.aspx.vb" Inherits="IControlIT.Holding" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <asp:Label ID="lblLogo" runat="server" CssClass="configlabel" Text="Logo"></asp:Label>
                            <asp:TextBox ID="txtLogo" runat="server" CssClass="configtext" MaxLength="50" Width="100%" TabIndex="2"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
    ...
    <asp:Panel ID="pnlValidador" runat="server" Style="z-index: 107; left: 191px; position: absolute; top: 291px; height: 38px; width: 129px;">
