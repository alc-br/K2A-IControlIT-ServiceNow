<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeBehind="Servico.aspx.vb" Inherits="IControlIT.Servico" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlValidador" runat="server" Style="z-index: 107; left: 209px; position: absolute; top: 283px; height: 38px; width: 130px;">
