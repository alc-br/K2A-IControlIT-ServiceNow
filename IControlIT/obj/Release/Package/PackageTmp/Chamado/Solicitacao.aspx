<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeBehind="Solicitacao.aspx.vb" Inherits="IControlIT.Solicitacao" EnableEventValidation="true" %>
                ...
                <div id="divInformacao" runat="server" visible="true" class="row">
                    <div class="col-md-12">
                        <div class="card-body" style="box-shadow: none;">
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:Label ID="lblTitulo" runat="server" ForeColor="#818181" Font-Names="Segoe UI Semibold" Font-Size="22pt" Text="Solicitação"></asp:Label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <asp:Label ID="lblSolicitacao" runat="server" Style="float: left" CssClass="configlabel" Text="* Tipo da Requisição"></asp:Label>
                                        <asp:DropDownList ID="cboSolicitacao" runat="server" CssClass="configCombo" EnableTheming="True" Width="100%" AutoPostBack="true"></asp:DropDownList>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <div id="tbBotao" runat="server" class="scrollmenu">
        ...
        <asp:LinkButton ID="btEncerrar" runat="server" CssClass="btn-menu-toolbar" OnClientClick="return confirm('Você deseja encerrar a solicitação?');" Visible="true" Style="opacity: 0.3;" Enabled="false" OnClick="btEncerrar_Click">
            <i class="fas fa-recycle"></i>
            <br />
            <span id="lblEncerrar" runat="server">Encerrar</span>
        </asp:LinkButton>
        <asp:LinkButton ID="btInformacoes" runat="server" CssClass="btn-menu-toolbar" CausesValidation="false" Visible="true" Style="opacity: 0.3;" Enabled="false" OnClick="btInformacoes_Click">
            <i class="fas fa-cog"></i>
            <br />
            <span id="lblInformacoes" runat="server">Unidade</span>
        </asp:LinkButton>
        <asp:LinkButton ID="btAvaliacao" runat="server" CssClass="btn-menu-toolbar" CausesValidation="false" Visible="true" Style="opacity: 0.3;" Enabled="false" OnClick="btAvaliacao_Click">
