<%@ Page Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeBehind="Estoque_Aparelho_Status.aspx.vb" Inherits="IControlIT.Estoque_Aparelho_Status" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlValidador" runat="server" Style="z-index: 107; left: 271px; position: absolute; top: 299px; height: 38px; width: 144px;">
